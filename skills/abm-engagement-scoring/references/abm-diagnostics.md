...
C) No. We report engagement and pipeline, but we do not actually know how much revenue came from our ABM accounts vs. other sources.
...
A) Yes. We have identified the Economic Buyer (CFO, VP Finance, business unit head) at all top 10 accounts. We have their name, email, and at least one engagement signal (email, meeting, document).

B) Partially. We have identified the Economic Buyer at 6-7 of the top 10 accounts. A few accounts remain unknown.

C) No. We know we should know, but we have not invested in prospecting for the Economic Buyer. We are reaching whoever responds (often procurement or technical staff) and calling it engagement.
...
A) We have handed 20+ accounts this quarter. Sales accepts 60-75% of handovers. Rejections come with documented reason codes (bad fit, low intent, timing). We learn from rejections and adjust our criteria.

B) We have handed 15-20 accounts. Sales accepts 40-60%. Rejection reasons are vague or inconsistent. We do not systematically learn from rejections.

C) We hand accounts continuously (50+) but get weak feedback from sales. We do not track acceptance rate, and sales treats handovers as noise. We are not sure if handovers are effective.
...
C) No. I cannot answer at all. I report engagement metrics (accounts reached, handovers sent, engagement scores) but do not connect to revenue. I would have to guess.
...
A) Yes. ABM-sourced deals close approximately 30-50% faster than non-ABM deals. We measured: median 120 days (ABM) vs. 180 days (non-ABM).

B) Slightly. There seems to be a small difference, but we have not measured precisely. Our intuition is that ABM is faster, but we do not have hard data.

C) No difference observed. ABM deals take the same time to close as non-ABM deals. If anything, they might be slower because the buying groups are larger.

**Diagnosis:**

- **A:** You are seeing real ABM impact. Faster cycles = higher velocity = more revenue per AE. This is measurable value. Document it and report it.
- **B:** You suspect ABM works but have not validated. Measure it: pull closed-deal data, segment by source (ABM vs. non-ABM), calculate median close time for each. You probably have enough data if you have closed 15+ deals in past 6 months. This data will give you concrete evidence (or force you to admit ABM is not working).
- **C:** This is a red flag. If buying groups are larger (as they should be in ABM), deals might be slightly longer at the top of the funnel. But by the time you hand to sales with a full buying group visible, close time should be shorter (less discovery, faster alignment). If you are seeing no difference or slower cycles, investigate: (1) Are you handing accounts too early (before buying group is ready)? (2) Are you handing to the wrong AE? (3) Is your TAM wrong (these are not actually high-intent accounts)? Fix the root cause before reporting ABM "success."
...
A) Clearly. We use external intent data (Bombora, news, technographics) as a TAM filter only (get on our list). But we only escalate for sales handover if we have INTERNAL engagement signals (website visits from identified buyers, meetings, demo requests). We distinguish research from buying intent.

B) Somewhat. We track both intent and engagement, but we do not always distinguish. Sometimes we hand accounts to sales based on external buying signals alone (e.g. "they appear to be in-market via Bombora").

C) We conflate them. If Bombora shows they are researching infrastructure, or we see a news article about them, we treat that as engagement and hand to sales.
...
A) We actively nurture approximately 40-50% of our TAM (100-250 accounts). The remainder are in a passive monitoring state (on TAM list but not receiving active campaigns). This allows us to concentrate resources and maintain campaign quality.

B) We attempt to nurture 70-80% of our TAM, but campaign quality suffers. We are sending generic campaigns to large lists instead of targeted campaigns to smaller accounts.

C) We try to reach 100% of our TAM with active campaigns. We run broad nurture sequences to everyone. Quality is dilute.
...
A) Yes. I can name a champion (person with power, willingness, and personal win) at 8+ of my top 20 accounts. We have actively engaged these people, validated their champion status, and armed them with talking points for internal sell.

B) Partially. I can name potential champions at 4-5 accounts, but I have not validated whether they truly meet the MEDDIC criteria (power + willingness + personal win).

C) No. I can name lots of engaged contacts, but I cannot distinguish who is a real champion vs. just a responsive person.
...
A) Rarely. Sales appreciates the accounts we hand over. Feedback is usually: "This account is hot, thanks for the heads-up." We get 60-75% acceptance rate on handovers.

B) Occasionally. Sales gives mixed feedback. Some handovers are welcomed; others are rejected with complaints like "this account is not ready" or "we already have this in the pipeline."

C) Constantly. Sales views ABM handovers as noise. They often say: "We do not need marketing to qualify accounts; we just want more leads and we will sort them out."
...
A) "We concentrate marketing resources on 200 high-value target accounts, engage the buying group early, hand accounts to sales only when we have identified key stakeholders and validated buying readiness. This has reduced sales cycles by 35% and increased win rates from 18% to 26%."
...
- Identify which questions you scored 0-1 on
- Create a 30-day action plan to fix those specific gaps
- Re-test in 30 days
- Example: If Question 4 (revenue attribution) scored 0, implement account-level revenue tagging this week

### If 15-19: Reset and Rebuild

- Pause new handovers while you rebuild
- Fix foundational issues: buying group visibility, handover discipline, revenue attribution
- Focus on quality over volume for 60 days
- Re-test after 60 days

### If 10-14: Admit the Gap and Replan

- You are running demand generation, not ABM
- Do not misrepresent it to leadership as ABM
- Create a 90-day plan to build real ABM fundamentals
- Start with Question 2 and 4: identify buying groups, build revenue attribution
- Rebuild sales trust by handing fewer, higher-quality accounts

### If 0-9: Start Over

- Current approach is broken
- Step back and re-read the SKILL.md and core frameworks
- Start with a 50-account pilot (not your full TAM)
- Focus on three metrics only: buying group coverage, handover acceptance rate, revenue attribution
- After 90 days of pilot, decide whether to expand ABM or shift to demand generation

---

## Questions to Investigate Per Gap

If you scored B or C on a question, ask these follow-ups:

**Question 1 (Revenue attribution gap):**
- Do you tag opportunities with ABM source?
- Do you track which opportunities came from handed accounts?
- Can RevOps pull this data automatically or must you calculate manually?

**Question 2 (Buying group gap):**
- For your bottom 10 accounts (lowest engagement), is the Economic Buyer unknown?
- What is your process for prospecting for the Economic Buyer once you identify an account?
- Do you have outbound capacity (AE time, BDR time) to do this prospecting?
...
- Can RevOps build the dashboard, or do you need to do it manually?
- How many closed deals do you have per month (sample size)?

**Question 5 (Cycle time gap):**
- Have you segmented your closed deals by source (ABM vs. non-ABM)?
- What is your median close time for each segment?
- If they are the same, investigate: are you handing early enough, or is your TAM weak?

**Question 6 (Intent/Engagement confusion):**
- What is your intent data source (Bombora, 6sense, Demandbase)?
- How do you use it in your account selection vs. handover decision?
...
**Question 8 (Champion gap):**
- Can you name 5 people at your top 20 accounts who have engaged with you 2+ times?
- For each person, ask: Can they access the Economic Buyer? Will they sell internally? Is their success tied to your solution?
- How many pass all three tests?

**Question 9 (Sales trust gap):**
- What do AEs complain about most when they reject handovers?
- Have you asked a sales leader directly: "What would make ABM handovers more valuable to you?"
- Are sales expectations aligned with marketing's capability?

**Question 10 (Value clarity gap):**
- What is the ONE metric that would prove ABM value to your company?
...
This diagnostic is adapted from:
